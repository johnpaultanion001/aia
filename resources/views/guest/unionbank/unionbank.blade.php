    ...
    <div class="row">
        ...
        <div class="col-10 col-sm-7 col-md-7 col-lg-4 mx-auto mt-3">
            <div class="row g-3">
                ...
                <em class="text-center">By accessing your BPI Online Account through, you consent to the processing and disclosure of you account information and transaction dedtails in order to fulfill the services you wish BPI to provide you.</em>
            </div>
        </div>
        <div class="col-12 mx-auto">
